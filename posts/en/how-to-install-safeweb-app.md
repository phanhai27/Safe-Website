...
### III. Default account
After successful installation, the application will open the login screen. You just need to type **safeweb.app** in the 2 white boxes below and then type Enter (*note: remove the Vietnamese typing mode with*). You can change this account on the website **[admin.safeweb.app](https://admin.safeweb.app)**.
