...
export default function BlogHead ({postData, lang}) {
    return (
        <Head>
            ...
            <meta itemProp="name" content={postData.article.title + "- SafeWeb"}/>
            ...
            <meta property="og:title" content={postData.article.title + "- SafeWeb"}/>
            ...
            <meta property="twitter:title" content={postData.article.title + "- SafeWeb"}/>
