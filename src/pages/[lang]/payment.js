...
function PaymentPage({ language, downloadData, htmlMeta }) {
    React.useEffect(() => {
        gaRunScript();
    }, [])
            ...
            <div className="row mt-4">
                ...
                <div className="col-md-12 mt-3">
                    ...
                    <div className="buttons">
                        <a id="dlink" href="#" className="btn btn-info btn-lg" data-wow-duration="2s" data-wow-delay="0.2s" style={stylingLeft}><i className="fa fa-credit-card"></i> Payment<br /> <small>{downloadData.windows.version}</small></a>
                    </div>
                </div>
            </div>
        </div>
...
export async function getStaticProps({ params }) {
    ...
    const filepath = path.join(process.cwd(),"src", "locales", lang, "payment.md");
